 ...
 */
export class DurationControl extends React.Component<
    DurationControlProps,
    DurationControlState
> {
    ...
    public constructor(props: DurationControlProps) {
        ...
        const lastFocusedInputUnitType =
            DurationControl._getSmallestUnitElementType(elements);
    ...
    public static getDerivedStateFromProps(
        ...
        if (
            nextProps.value === prevState.milliseconds &&
                ...
                <div className="control-wrapper">
                    ...
                    {this.props.hideSpinner ? (
                        ...
                        <Spinner
                            onUpButtonPress={() =>
                                this._incrementOrDecrementUnitValue(
                                    this.state.lastFocusedInputUnitType,
                                    true
                                )
                            }
                            onDownButtonPress={() =>
    ...
    private _updateUnitValue(
        ...
        const unitValueMillisDifference =
            newUnitValueMillis - previousUnitValueMillis;

        const updatedMilliseconds =
            this.state.milliseconds + unitValueMillisDifference;
    ...
    private static _spreadMillisAcrossUnitElements(
        ...
        const getUnitElement = (type: DurationUnitType) =>
            elements.find(
                (element) =>
                    typeof element !== "string" && element.type === type
            ) as DurationControlUnit;

        const unitTypeArray: DurationUnitType[] = [
            "day",
            "hour",
            "minute",
            "second",
    ...
    private static _getSmallestUnitElementType(
        ...
        const unitsAscending: DurationUnitType[] = [
            "millisecond",
            "second",
            "minute",
            "hour",
        ...
        for (const unit of unitsAscending) {
            if (
                !!elements.find(
                    (element) =>
                        typeof element !== "string" && element.type === unit
                )
            ) {
                return unit;
            }
